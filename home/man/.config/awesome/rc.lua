...
terminal = "urxvtc -geometry 84x24"
...
globalkeys = gears.table.join(
      ...
      function()
        awful.spawn.easy_async(
          ...
          function(stdout, stderr, reason, exit_code)
            ...
            local path = "/tmp/" .. user .. "/areashot-" .. timestamp .. ".png"
      ...
      function()
        awful.spawn.easy_async(
          ...
          function(stdout, stderr, reason, exit_code)
            local timestamp = stdout:gsub("\n", "")
            local user = os.getenv("USER")
            local path = "/tmp/" .. user .. "/screenshot-" .. timestamp .. ".png"
    ...
    awful.key({ modkey, "Control", "Shift" }, "l", function () awful.spawn('slimlock'); awful.spawn('sudo sleep-ram') end,
              {description = "lock screen with sleep to ram", group = "awesome"}),
    awful.key({ modkey, "Control" }, "s", function () awful.spawn('sudo sleep-ram') end,
              {description = "sleep to ram", group = "awesome"}),
    awful.key({ modkey, "Control", "Shift" }, "s", function () awful.spawn('slimlock'); awful.spawn('sudo sleep-ram') end,
              {description = "sleep to ram with lock", group = "awesome"}),
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = beautiful.border_width,
                     ...
                     size_hints_honor = false, -- Remove gaps for terminals
